...
- 大きな自己紹介cardや実績の自己採点を置かず、「書いていること」だけを短い本文とtagで説明する。「日付を変えずに残す」「迷った過程も書く」の方針sectionは置かない。
- 2019 / 2020 / 2026の履歴を細いruleで示し、GitHub・Qiita・X・Writingsへの外部導線を本文より弱い階層で置く。
- 1280px幅の初見で主見出し、履歴、最初の説明まで見せ、巨大文字と長いscrollを避ける。

### Global navigation

- wordmarkのホーム導線に加え、`ホーム`、`記事一覧`、`ブログについて`を明示する。
- 3リンクは390px幅でも省略せず、header内で横overflowさせない。
